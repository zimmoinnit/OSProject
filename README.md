...
1. What is the link of the fork OSProject in your repository. ***(1 mark)*** https://github.com/codespaces?repository_id=750447002
...
1. What is the permission of folder /usr/local/apache/htdocs and what user and group owns the folder? . ***(2 mark)*** __Permission: drwxr-xr-x or 755 Owner:Root__.
